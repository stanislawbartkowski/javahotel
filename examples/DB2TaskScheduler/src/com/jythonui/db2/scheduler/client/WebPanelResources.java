...
class WebPanelResources implements IWebPanelResources {
    ...
    WebPanelResources() {
        ma.put(TITLE, "DB2 Task scheduler");
        ma.put(PRODUCTNAME, "DB2 Task scheduler");
        ma.put(OWNERNAME, "Demo version");
        ma.put(VERSION, "DB2 Task scheduler v 1.1");
        ma.put(IIMAGEPRODCUT, "taskscheduler_icon.png");
    }
