...
public interface jTPCCConfig
{
    ...
    public final static String defaultNumWarehousesP = "NoW";
    public final static String defaultNumTerminalsP = "NoT";
    ...
    public final static String defaultTransactionsPerTerminalP = "NoPT";
    public final static String defaultMinutesP = "NoM";
//    public final static boolean defaultRadioTimeP = true;
