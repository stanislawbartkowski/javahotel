...
public class GetRecordDefFactory {
    ...
    private static ArrayList<RecordField> getStandDict(final IResLocator rI,
            String symName, boolean enable) {
        ArrayList<RecordField> dict = new ArrayList<RecordField>();
        ...
        dict.add(new RecordField("Nazwa", descr, DictionaryP.F.description, true));
        return dict;
    }
    ...
    private static ArrayList<RecordField> getDef(final IResLocator rI, final RType rt) {
        ArrayList<RecordField> dict = new ArrayList<RecordField>();
        ILineField name = GetIEditFactory.getTextEditI(rI);
        switch (rt) {
            case AllPersons:
                ...
                dict.add(new RecordField("Hasło", password,
                        LoginRecord.F.password, true));
            ...
            case AllHotels:
                ...
                dict.add(new RecordField("Nazwa", name,
                        HotelP.F.name, false));
                dict.add(new RecordField("Opis", descr,
                        HotelP.F.description, true));
    ...
    private static ArrayList<RecordField> getDef(final IResLocator rI,
            final DictData.SpecE e) {
        ArrayList<RecordField> dict = null;
        switch (e) {
            case SpecialPeriod:
                ...
                dict.add(new RecordField("Od", fromP,
                        OfferSeasonPeriodP.F.startP, true));
                dict.add(new RecordField("Do", endP,
                        OfferSeasonPeriodP.F.endP, true));
                break;
            ...
            case BookingHeader:
                ...
                dict.add(new RecordField("Cennik", oPrice,
                        BookRecordP.F.oPrice, true));
                break;
            ...
            case BookingElem:
                ...
                dict.add(new RecordField("Pokój", resObject,
                        BookElemP.F.resObject, true));
                dict.add(new RecordField("Usługa", service,
                        BookElemP.F.service, true));
                break;
            case RowPaymentElem:
            ...
            case AddPayment:
                ...
                ILineField resType = GetIEditFactory.getEnumMap(rI,
                        rI.getLabels().BookingStateType());
                ILineField payMethod = GetIEditFactory.getEnumMap(rI,
                        rI.getLabels().PaymentMethod());
                ILineField dateAmount = GetIEditFactory.getTextCalendard(rI);
                dict = new ArrayList<RecordField>();
                dict.add(new RecordField("Zaliczka", amount,
                        PaymentP.F.amount, true));
                ...
                break;
            case ResGuestList:
                ArrayList<RecordField> cList = getDef(rI, new DictData(DictType.CustomerList));
                checkIn = GetIEditFactory.getTextCalendard(rI);
                checkOut = GetIEditFactory.getTextCalendard(rI);
                cList.add(new RecordField("Od", checkIn,
                        GuestP.F.checkIn, true));
                cList.add(new RecordField("Do", checkOut,
                        GuestP.F.checkOut, true));
                descr = GetIEditFactory.getTextEditI(rI);
                ILineField numb = GetIEditFactory.getTextEditI(rI);
                cList.add(new RecordField("Numer", numb,
                        ResRoomGuest.F.name, true));
                cList.add(new RecordField("Opis", descr,
                        ResRoomGuest.F.desc, true));
                dict = cList;
                break;
            case BillsList:
                dict = new ArrayList<RecordField>();
                p = rI.getR().getHotelCommandParam();
                p.setDict(DictType.PriceListDict);
                oPrice = GetIEditFactory.getListValuesBox(rI,
                        RType.ListDict, p, DictionaryP.F.name, null);
                dict.add(new RecordField("Cennik", oPrice,
                        BillsCustomer.F.oPrice, true));
                ILineField name = GetIEditFactory.getTextCheckEditI(rI, true);
                dict.add(new RecordField("Symbol", name,
                        BillsCustomer.F.name, true));
                descr = GetIEditFactory.getTextEditI(rI);
                dict.add(new RecordField("Symbol", descr,
                        BillsCustomer.F.descr, true));
                p = rI.getR().getHotelCommandParam();
                ...
                dict.add(new RecordField("Klient", custName,
                        DictionaryP.F.name, true));
                break;
            case AddPaymentList:
                dict = new ArrayList<RecordField>();
                ILineField dOp = GetIEditFactory.getTextCalendard(rI);
                dict.add(new RecordField("Data usługi", dOp,
                        AddPaymentP.F.payDate, true));
                descr = GetIEditFactory.getTextEditI(rI);
                dict.add(new RecordField("Opis", descr,
                        AddPaymentP.F.remarks, true));
                p = rI.getR().getHotelCommandParam();
                p.setDict(DictType.ServiceDict);
                ILineField seName = GetIEditFactory.getListValuesBox(rI,
                        RType.ListDict, p, DictionaryP.F.name);
                dict.add(new RecordField("Usługa", seName,
                        AddPaymentP.F.seName, true));
                amount = GetIEditFactory.getNumberCalculator(rI);
                dict.add(new RecordField("Ilość", amount,
                        AddPaymentP.F.noSe, true));
                amount = GetIEditFactory.getNumberCalculator(rI);
    ...
    public static ArrayList<RecordField> getDef(final IResLocator rI,
        ...
        switch (da.getD()) {
            ...
            case RoomObjects:
                ...
                ILineField standardB = GetIEditFactory.getListValuesBox(rI, RType.ListDict,
                        p, DictionaryP.F.name);
            ...
            case VatDict:
                ...
                dict.add(new RecordField("Procent", percent, VatDictionaryP.F.vat, true));
                break;
            case ServiceDict:
                dict = getStandDict(rI, "Symbol");
                p = rI.getR().getHotelCommandParam();
                p.setDict(DictType.VatDict);
                ILineField vatServ = GetIEditFactory.getListValuesBox(rI, RType.ListDict, p,
                        DictionaryP.F.name);
                ILineField servType = GetIEditFactory.getEnumMap(rI, rI.getLabels().Services());
                dict.add(new RecordField("Vat", vatServ,
                        ServiceDictionaryP.F.vat, true));
                dict.add(new RecordField("Typ", servType,
                        ServiceDictionaryP.F.servtype, true));
                break;
            case OffSeasonDict:
                dict = getStandDict(rI, "Symbol");
//                ILineField fromP = (DateCalendar) GetIEditFactory.getTextCalendard(rI);
//                ILineField toP = (DateCalendar) GetIEditFactory.getTextCalendard(rI);
                ILineField fromP = GetIEditFactory.getTextCalendard(rI);
...
//                getTextCheckEditI
                ...
                ILineField name = GetIEditFactory.getTextCheckEditI(rI, true);
                ILineField descr = GetIEditFactory.getTextEditI(rI);
                dict.add(new RecordField("Symbol", name, DictionaryP.F.name, false));
                dict.add(new RecordField("Nazwa", descr, DictionaryP.F.description, true));
                ...
                ILineField pType = GetIEditFactory.getEnumMap(rI, rI.getLabels().PTitles());
                ILineField docType = GetIEditFactory.getEnumMap(rI, rI.getLabels().DocTypes());
                ILineField docNumber = GetIEditFactory.getTextEditI(rI);


                ILineField city = GetIEditFactory.getTextEditI(rI);
                ILineField cType = GetIEditFactory.getEnumMap(rI,
                        rI.getLabels().CustomerType());
                dict.add(new RecordField("Nazwa 1", name1, CustomerP.F.name1,
                        true));
                dict.add(new RecordField("Nazwa 2", name2, CustomerP.F.name2,
                        true));
                dict.add(new RecordField("Rodzaj", cType, CustomerP.F.cType,
                        true));

                dict.add(new RecordField("Pan/Pani", pType, CustomerP.F.pTitle,
                        true));
                dict.add(new RecordField("Imię", fname, CustomerP.F.firstName,
                        true));
                dict.add(new RecordField("Nazwisko", lname, CustomerP.F.lastName,
                        true));
                dict.add(new RecordField("PESEL", pesel, CustomerP.F.PESEL,
                        true));
                ...
                dict.add(new RecordField("Kraj", country, CustomerP.F.country,
                        true));
                dict.add(new RecordField("Kod pocztowy", zipCode,
                        CustomerP.F.zipCode, true));
                dict.add(new RecordField("Miasto", city, CustomerP.F.city,
                        true));
            ...
            case BookingList:
                ...
                dict.add(new RecordField("Od", dFrom, BookingP.F.checkIn,
                        true));
                dict.add(new RecordField("Do", dTo, BookingP.F.checkOut,
                        true));
                dict.add(new RecordField("Sezon", season, BookingP.F.season,
                        true));
                dict.add(new RecordField("Liczba osób", noPerson, BookingP.F.noPersons,
                        true));
                break;
        }
    ...
    private static ArrayList<RecordField> getLoginDef(final IResLocator rI,
            final boolean user) {
        ArrayList<RecordField> dict = new ArrayList<RecordField>();
        ILineField name = GetIEditFactory.getTextEditI(rI);
        ...
        if (user) {
            ...
            dict.add(new RecordField("Hotel", hotel, LoginRecord.F.hotel, false));
        }
        return dict;
    }
}
