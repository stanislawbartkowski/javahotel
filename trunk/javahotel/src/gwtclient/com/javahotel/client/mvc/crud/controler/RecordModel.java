...
public class RecordModel {
	...
	private ArrayList<? extends AbstractTo> aList;
	private ArrayList<? extends AbstractTo> beforeaList;
	 ...
	 * @return the aList
	 */
	public ArrayList<? extends AbstractTo> getAList() {
		return aList;
	}
	 ...
	 *            the aList to set
	 */
	public void setAList(ArrayList<? extends AbstractTo> aList) {
		this.aList = aList;
	}
	 ...
	 */
	public ArrayList<? extends AbstractTo> getBeforeaList() {
		return beforeaList;
	}
	 ...
	 */
	public void setBeforeaList(ArrayList<? extends AbstractTo> beforeaList) {
