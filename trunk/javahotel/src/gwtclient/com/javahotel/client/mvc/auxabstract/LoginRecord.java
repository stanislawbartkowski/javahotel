...
public class LoginRecord extends AbstractTo {
    ...
    public Object getF(IField f) {
        ...
        switch (fi) {
            ...
            case hotel: return getHotel();
            case confpassword: return getConfpassword();
        }
        return null;
    }
    ...
    public void setF(IField f, Object o) {
        F fi = (F) f;
        switch (fi) {
            case login: setLogin((String) o); break;
            case password: password = (String) o; break;
            case hotel: hotel = (String) o; break;
            case confpassword: confpassword = (String) o; break;
        }
    }
