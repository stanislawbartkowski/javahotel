...
public class ColListFactory {
    ...
    private static ArrayList<ColTitle> createA(String sy) {
        ...
        a.add(new ColTitle(DictionaryP.F.name, sy,100));
        a.add(new ColTitle(DictionaryP.F.description, "Opis",100));
        return a;
    }
    ...
    static {
        ...
        hotelCol.add(new ColTitle(HotelP.F.name, "Nazwa",100));
        hotelCol.add(new ColTitle(HotelP.F.description, "Opis",120));
        hotelCol.add(new ColTitle(HotelP.F.database, "Baza",80));

        personCol = new ArrayList<ColTitle>();
        personCol.add(new ColTitle(LoginRecord.F.login, "Nazwa",100));
        ...
        bankCol.add(new ColTitle(BankAccountP.F.accountNumber, "Numer rachunku"));
        ...
        conflictRowCol.add(new ColTitle(ResDayObjectStateP.F.bookName, "Nazwa rezerwacji"));
