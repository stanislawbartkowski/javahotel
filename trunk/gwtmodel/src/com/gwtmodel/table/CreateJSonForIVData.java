 ...
 * @author perseus
 */
public class CreateJSonForIVData {

    private CreateJSonForIVData() {
    }

    public static String construct(IVModelData line, String oName) {
    ...
    public static String construct(IVModelData line) {
