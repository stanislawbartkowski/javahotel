...
public interface IMess {
    ...
    String INVOICEPATTID = "InvoicePattId";
    String INVOICEPATT = "InvoiceCompanyPatt";
    String INVOICEXSDFILDER = "xsd";
    String INVOICEPATTERN = "Invoice.pattern";
    String IDATETYPE = "date";
    String IDECIMALTYPE = "decimal";
    String IINTTYPE = "int";
    String INVOICEXSD = "InvoiceXMLSchema.xsd";
}
