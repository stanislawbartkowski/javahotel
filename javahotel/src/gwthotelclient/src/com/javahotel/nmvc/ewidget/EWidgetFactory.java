...
public class EWidgetFactory {
    ...
    public IFormLineView getListValuesBox(IVField v, final RType r,
            final CommandParam p, final IField f) {
        return eFactory.constructListValuesCombo(v, new GetCommandList(pLoc, r,
                p, f));
    }

    public IFormLineView getListValuesBox(IVField v, final CommandParam p,
            IField sel) {
        return getListValuesBox(v, RType.ListDict, p, sel);
    }
