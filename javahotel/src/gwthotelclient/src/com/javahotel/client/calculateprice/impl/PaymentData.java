 ...
 */
package com.javahotel.client.calculateprice.impl;
...
public class PaymentData implements IPaymentData {
    ...
    private class SRows extends SynchronizeList {
        ...
        SRows(final Date dFrom, final Date dTo, final String service,
                final ISetPaymentRows i) {
            super(2);
            this.dFrom = dFrom;
            this.dTo = dTo;
    ...
    @Override
    public void setPaymentData(final String season, final String sprice,
            final Date dFrom, final Date dTo, final String service,
            final ISetPaymentRows i) {
        boolean start = true;
