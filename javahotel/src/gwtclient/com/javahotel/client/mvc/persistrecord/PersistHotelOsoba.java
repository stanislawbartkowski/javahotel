...
import com.javahotel.client.CallBackHotelNumb;
...
class PersistHotelOsoba implements IPersistRecord {
	...
	private class ActionAB extends CallBackHotelNumb {
	...
	private class PersistBack extends CallBackHotel {
	...
	private class RemoveBack extends CallBackHotel {
