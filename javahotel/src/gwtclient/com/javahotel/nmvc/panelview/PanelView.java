 ...
 */
package com.javahotel.nmvc.panelview;
...
import com.javahotel.view.ngwt.panel.GwtPanelViewFactory;
import com.javahotel.view.ngwt.panel.IGwtPanelView;
import com.javahotel.view.ngwt.panel.PanelRowDesc;
...
class PanelView extends AbstractSlotContainer implements IPanelView {
    ...
    private class SetWidget implements ISlotSignaller {
        ...
        public void signal(ISlotSignalContext slContext) {
            ...
            IGwtWidget gwtWidget = slContext.getGwtWidget();
            pView.setWidget(pa.rowNo, pa.cellNo, gwtWidget);
        }
