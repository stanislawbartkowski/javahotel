...
//                }
    ...
    private class OrderNotFoundException extends Exception {
        ...
        OrderNotFoundException(String mess) {
            super(mess);
        }
    ...
    private void orderStatusTransaction(int w_id, int d_id, int c_id, String c_last, boolean c_by_name)
    {
        ...
        try
        {
            if(c_by_name)
            {
                ...
                if(!rs.next()) {
                    throw new OrderNotFoundException("C_LAST=" + c_last + " C_D_ID=" + d_id + " C_W_ID=" + w_id + " not found!");
                }
            ...
            terminalMessage("This order is not found:" + e.getMessage());
        }
        catch(Exception e)
        {
            error("ORDER-STATUS");
