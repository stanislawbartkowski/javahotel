...
@Stateless
@EJB(name = IHotelConsts.TESTHOTELROOMSJNDI, beanInterface = ITestHotelRooms.class)
@Remote
@Interceptors(value = { GuiceInterceptor.class })
public class TestHotelRoomsEJB extends AbstractHotelEJB<HotelRoom> implements
        ITestHotelRooms {
    ...
    public void injectHotelServices(
            @Named(IHotelConsts.TESTHOTELROOMS) IHotelRooms injectedServices) {
