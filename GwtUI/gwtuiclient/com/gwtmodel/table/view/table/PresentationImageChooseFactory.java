...
class PresentationImageChooseFactory extends PresentationEditCellHelper {
    ...
    PresentationImageChooseFactory(ErrorLineInfo errorInfo,
    ...
    private class HasStringButtonCellImage implements HasCell {
        ...
        class Delegate implements ActionCell.Delegate<String> {
            ...
            private class SetString implements
                    IColumnImageSelect.IExecuteSetString {
    ...
    private class StringImageCell extends ActionCell<String> {
        ...
        StringImageCell(HasStringButtonCellImage.Delegate delegate,
                VListHeaderDesc he) {
            super("", delegate);
            this.he = he;
            this.v = he.getFie();
    ...
    private List<HasCell<String, ?>> createList(HasCell<String, ?> c1,
            HasCell<String, ?> c2) {
    ...
    private class CellPickerString extends CompositeCell<String> implements
            IGetField {

        private final EditStringCell dCell;

        @SuppressWarnings("unchecked")
        public CellPickerString(HasEditStringCell dateCell,
                HasStringButtonCellImage cellImage) {
