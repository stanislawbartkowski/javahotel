...
class PresentationEditSelectionCellFactory extends PresentationEditCellHelper {
    ...
    private class EditSelectionCell extends CustomizedGwtSelectionCell
        ...
        @Override
        public void render(final Cell.Context context, String value,
    ...
    Column constructSelectionCol(VListHeaderDesc he, List<String> lis,
            AbstractListT listT) {
        assert !lis.isEmpty() : LogT.getT().SelectListCannotBeEmpty();
        IVField v = he.getFie();
        Column co = new TColumnEdit(v, new EditSelectionCell(he, lis, listT));
        return co;
    }
}
