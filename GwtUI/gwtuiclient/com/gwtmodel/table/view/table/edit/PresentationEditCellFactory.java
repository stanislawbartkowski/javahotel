 ...
 * 
 */
class PresentationEditCellFactory extends PresentationEditCellHelper implements
        IPresentationCellEdit {

    private final IGwtTableView pTable;
     ...
     */
    @Override
    public ErrorLineInfo getErrorInfo() {
        return errorInfo;
    }

    @Override
    public void setErrorLineInfo(MutableInteger key,
    ...
    @Override
    public Column constructNumberCol(VListHeaderDesc he) {
    ...
    @SuppressWarnings("rawtypes")
    @Override
    public Column constructDateEditCol(VListHeaderDesc he) {
        return dFactory.constructDateEditCol(he);
    }

    @SuppressWarnings("rawtypes")
    @Override
    public Column contructBooleanCol(IVField v, boolean handleSelection) {
        return checkFactory.contructBooleanCol(v, handleSelection);
    }

    @SuppressWarnings("rawtypes")
    @Override
    public Column constructEditTextCol(VListHeaderDesc he) {
