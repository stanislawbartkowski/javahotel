...
import com.gwtmodel.table.view.table.edit.PresentationEditCellHelper.InputTemplate;

/**
 * Copy and paste of GWT standard SelectionCell
 * The only difference is to add style and css to Select tag
 */

/**
 * A {@link Cell} used to render a drop-down list.
 */
abstract class CustomizedGwtSelectionCell extends
    ...
    interface SelectTemplate extends SafeHtmlTemplates {
        ...
        @SafeHtmlTemplates.Template("<select tabindex=\"-1\" style=\"{0}\" class=\"{1}\">")
