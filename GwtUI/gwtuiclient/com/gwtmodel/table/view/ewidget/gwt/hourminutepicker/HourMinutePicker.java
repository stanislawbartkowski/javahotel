/**
 * http://code.google.com/p/gwt-timepicker/
 */

package com.gwtmodel.table.view.ewidget.gwt.hourminutepicker;
...
public class HourMinutePicker extends Composite {
    ...
    private final IOnChange iChange;
    ...
    public HourMinutePicker(PickerFormat format, int startHour, int endHour,
            int timeSlices, IOnChange iChange) {
    ...
    public HourMinutePicker(PickerFormat format, IOnChange iChange) {
        this(format, 0, 23, 4, iChange);
    }
    ...
    public void setTime(String suffix, int hour, int minute) {
        this.selectedSuffix = suffix == null
                || (!suffix.equals("AM") || !suffix.equals("PM")) ? "AM"
                : suffix;
