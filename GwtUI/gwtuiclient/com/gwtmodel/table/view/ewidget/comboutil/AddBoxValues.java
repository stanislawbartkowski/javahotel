...
public class AddBoxValues {
	...
	public static void addValues(IDataType dType, final IValueLB e) {
	...
	public static void addValues(IVField v, IGetDataList iGet, final IValueLB e) {
