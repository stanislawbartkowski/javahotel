...
public class ExportSchemas {
	...
	private static void printHelp() {
		P("Parameters:");
		P(" <property file> <export file>  ");
		P("Example: ");
		P(" /home/sb/export/prop.properties schema.list");
	}
	...
	public static void main(String[] args) {
		...
		log.info("Extract schemas to file " + args[1]);
		RunMain.doMain(args[0], new RunMain.RunTask() {
			...
			public void doTask(Connection con, Properties prop) throws SQLException, IOException {
				ExtractSchemas.exportList(con, prop, args[1]);
			}
		});
	}
