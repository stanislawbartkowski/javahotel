...
public interface IConsts {
	...
	String PANELINFOTITLE = "Title";
	String PANELINFOPRODUCTNAME = "ProductName";
	String PANELINFOOWNERNAME = "OwnerName";
	String PANELINFOVERSIONINFO = "Version";
	String PANELINFOPRODUCTIMAGE = "ProductImage";
