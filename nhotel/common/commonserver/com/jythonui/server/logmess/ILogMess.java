...
public interface ILogMess {
	...
	String WIDGETYPESNOTRECOGNIZED = "WIDGETYPESNOTRECOGNIZED";
	String CANNOTREADBINDERFILE = "CANNOTREADBINDERFILE";
	String BINDERWIDGETSHOULDCONTAINCHILD = "BINDERWIDGETSHOULDCONTAINCHILD";
	String UISTYLEUIBINDER = "UISTYLEUIBINDER";
	String ERRORWHILEPARSINGCSSELEMENT = "ERRORWHILEPARSINGCSSELEMENT";
	String LASTCHARACTERINSTYLEESOURCESHOULDBE = "LASTCHARACTERINSTYLEESOURCESHOULDBE";
	String STYLERESOURCESHOUlDSTARWITH = "STYLERESOURCESHOUlDSTARWITH";
	String STYLERESOURCENOTRECOGNIZED = "STYLERESOURCENOTRECOGNIZED";
	String MORETHENONEVALUESEXPECTED = "MORETHENONEVALUESEXPECTED";
	String ENVIRONMENTVARIABLENODEFINED = "ENVIRONMENTVARIABLENODEFINED";
	String CONTAINERRECOGNIZED = "CONTAINERRECOGNIZED";
	String LOOKUPCONTEXT = "LOOKUPCONTEXT";
	String ATTRIBUTNAMENOTCORRECT = "ATTRIBUTNAMENOTCORRECT";
	String ATTRIBUTEVALNOTCORRECT = "ATTRIBUTEVALNOTCORRECT";
	String AJAXFIELDBADFORMAT = "AJAXFIELDBADFORMAT";
	String CANNOTUIBINDERFILEANDCONTENT = "CANNOTUIBINDERFILEANDCONTENT";
};