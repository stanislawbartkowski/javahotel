...
def _setStandMessage(var,messtype,mess,title,action) :
    var[messtype] = mess
    if title : var[ICommonConsts.JMESSAGE_TITLE] = title
    if action : var[ICommonConsts.JAFTERDIALOGACTION] = action
    
def setOkMessage(var,mess,title=None,action=None) :
    _setStandMessage(var,ICommonConsts.JOKMESSAGE,mess,title,action)

def setYesNoMessage(var,mess,title=None,action=None) :
    _setStandMessage(var,ICommonConsts.JYESNOMESSAGE,mess,title,action)
...
def setBinderItemsAttr(var,id,val=True) :
    setBinderAttr(var,id,"items",val)        
...
def setToastText(var,id,text) :
    setLabelText(var,id,text)
    setBinderOpen(var,id)    
