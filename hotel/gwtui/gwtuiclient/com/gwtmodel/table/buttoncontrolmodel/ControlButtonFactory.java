...
public class ControlButtonFactory {
	...
	public ControlButtonDesc constructButt(StandClickEnum bType, ClickButtonType buttonType) {
		...
		case TABLEDEFAULTMENU:
			return new ControlButtonDesc(imageName, MM.getL().MenuForTable(), buttonType);

		case CLEARFILTER:
		case CLEARFIND:
			return new ControlButtonDesc(imageName, MM.getL().ClearParam(), buttonType);
		case FIND:
			return new ControlButtonDesc(imageName, MM.getL().SearchButton(), buttonType);

		case FINDFROMBEGINNING:
			return new ControlButtonDesc(imageName, MM.getL().SearchFromBeginning(), buttonType);

		case FINDNOW:
			return new ControlButtonDesc(imageName, MM.getL().SearchButton(), buttonType);
		case FINDNEXT:
			return new ControlButtonDesc(imageName, MM.getL().SearchNext(), buttonType);

		case SETFILTER:
			return new ControlButtonDesc(imageName, MM.getL().SetFilter(), buttonType);

		case REMOVEFILTER:
			return new ControlButtonDesc(imageName, MM.getL().RemoveFilter(), buttonType);

		case FILTRLIST:
			return new ControlButtonDesc(imageName, MM.getL().Filter(), buttonType);
		case ADDITEM:
			return new ControlButtonDesc(imageName, mAction.get(StandClickEnum.ADDITEM.name()), buttonType);
		case REMOVEITEM:
			return new ControlButtonDesc(imageName, mAction.get(StandClickEnum.REMOVEITEM.name()), buttonType);
		case MODIFITEM:
			return new ControlButtonDesc(imageName, mAction.get(StandClickEnum.MODIFITEM.name()), buttonType);
		case SHOWITEM:
			return new ControlButtonDesc(imageName, mAction.get(StandClickEnum.SHOWITEM.name()), buttonType);
		case ACCEPT:
			return new ControlButtonDesc(imageName, MM.getL().Accept(), buttonType);
		case RESIGN:
		case RESIGNLIST:
			return new ControlButtonDesc(imageName, MM.getL().Resign(), buttonType);
		case CHOOSELIST:
			return new ControlButtonDesc(imageName, MM.getL().Choose(), buttonType);
